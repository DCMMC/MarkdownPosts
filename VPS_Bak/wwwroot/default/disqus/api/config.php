...
define('DISQUS_USERNAME', 'DCMMC');
define('DISQUS_EMAIL', 'xwt97294597@gmail.com');
define('DISQUS_PASSWORD', '97294597');
define('DISQUS_WEBSITE', 'http://blog.dcmmcc.tk');
define('DISQUS_SHORTNAME', 'dcmmc');
